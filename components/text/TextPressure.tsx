// components/text/TextPressure.tsx
// Full, finalized version with stable setSize via useCallback and preserved styles/behavior
...
const TextPressure: React.FC<TextPressureProps> = ({
  ...
  const setSize = useCallback(() => {
    ...
    // Defer read-after-write to next frame to avoid layout thrash
